...
public class HexShop {
	...
	public static final DialogueNode EXTERIOR = new DialogueNode("Hendarix Hexes (Exterior)", "-", false) {
		
		@Override
		public String getContent() {
			return "<p>"
						+ "You find yourself outside a gaudily decorated shop "
						+ " Despite an enthusiastic attempt from one of the shop's attendants to get you to buy "
